...
pre = cv2.imread(r'D:\github_repository\MPM\data_sample\train_imgs\sample_sequence\0000.png', -1)#[500:600, 500:600]
cur = cv2.imread(r'D:\github_repository\MPM\data_sample\train_imgs\sample_sequence\0001.png.png', -1)#[500:600, 500:600]
mpm = np.load(r'D:\github_repository\MPM\data_sample\train_mpms\sample_sequence\001\0000.npy')#[500:600, 500:600]
vismpm = visualize3D(pre, cur, mpm,z_value = 2)
